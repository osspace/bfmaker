...
int main(int argc, char** argv) {
    ...
    auto bitmap = font_render.get_unicode_bitmap(L'中');
    bitmap.show();
    bitmap = font_render.get_unicode_bitmap(L'国');
    bitmap.show();
    bitmap = font_render.get_unicode_bitmap(L'制');
    bitmap.show();
    bitmap = font_render.get_unicode_bitmap(L'造');
    bitmap.show();
    bitmap = font_render.get_unicode_bitmap(L'，');
    bitmap.show();
    bitmap = font_render.get_unicode_bitmap(L'A');
    bitmap.show();
    bitmap = font_render.get_unicode_bitmap(L'B');
    bitmap.show();
    bitmap = font_render.get_unicode_bitmap(L'C');
    bitmap.show();
    bitmap = font_render.get_unicode_bitmap(L'D');
    bitmap.show();
    return 0;
}
